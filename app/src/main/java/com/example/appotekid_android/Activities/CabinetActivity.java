...
public class CabinetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) throws NullPointerException {
        ...
        // Create a new thread
        mAuthTask = new populateDataAsync(user.getId());
        ...
        final TableView<String[]> tb = this.findViewById(R.id.tableView);
        ...
        tb.addDataClickListener((rowIndex, clickedData) -> {
            ...
            Medicine med;
            med = medicineList.get(rowIndex);
            Intent intent1 = new Intent(CabinetActivity.this, SpecificMedicineActivity.class);
